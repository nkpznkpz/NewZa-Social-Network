...
<!-- Header -->	
	...
	<c:if test="${sessionScope['s_mId'] == null}">
        ...
        <div class="boxlink" id="loginButton" style="width:100px;float:right;" onclick="javascript:mainLogin.showWinLogin();"><img src="img/blue_speech_bubble.png">เข้าสู่ระบบ</div>
		</c:if>
		<c:if test="${sessionScope['s_mId']!=null}">
