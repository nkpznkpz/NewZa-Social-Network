...
<title>:: NewZa Social :: ค้นหาโปรไฟล์</title>
</head>
<body>
...
<script type="text/javascript" src='${pageContext.request.contextPath}/js/profileSearch.js'></script>
<!--<script type="text/javascript" src='${pageContext.request.contextPath}/js/profileView-jquery.js'></script>
