...
<title>:: NewZa Social Administrator :: จัดการผู้ดูแลระบบ</title>
</head>
<body>
...
<script type="text/javascript" src='${pageContext.request.contextPath}/js_admin/manageAdminUser.js'></script>
...
<!-- content -->
	<div id="content" class="newza">
		<div id=boxContent>
			<h3><img src="img/computer.png"> จัดการผู้ดูแลระบบ</h3>
