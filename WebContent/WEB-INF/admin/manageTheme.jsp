...
<!--custom style -->
<title>:: NewZa Social Administrator :: จัดการธีม</title>
</head>
<body>
...
<script type="text/javascript" src='${pageContext.request.contextPath}/js_admin/manageTheme.js'></script>
...
<!-- content -->
	<div id="content" class="newza">
		<div id=boxContent>
			<h3><img src="img/computer.png">จัดการธีม</h3>
			<table align="center" style="width:100%">
				<tr><td><div id="showTheme"></div></td></tr>
				<tr><td align="center"><div id="addTheme"></div></td></tr>
			</table>
			<br>
