...
<title>:: NewZa Social :: ความคิดเห็นทั้งหมด</title>
</head>
<body>
...
<script type="text/javascript" src='${pageContext.request.contextPath}/js/profileComment.js'></script>
...
<c:if test="${commentSt.status eq 'owner'}">
...
<!-- content -->
	<div id="content" class="newza" align="center">
		<div id=boxRender style="width: 100%">
